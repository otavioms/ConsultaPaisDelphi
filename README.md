...
TImage
- imgBandeiraPais — exibição da bandeira do país
...
4. Model.BandeiraPais.pas
Representa os dados da bandeira do país (PNG).

5. Service.Api.Pais.pas
...
5. A aplicação exibirá os dados do país e sua respectiva bandeira.
...
- Consumo e exibição de imagens a partir de URLs
